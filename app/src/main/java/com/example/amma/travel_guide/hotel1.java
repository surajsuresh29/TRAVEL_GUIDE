...
public class hotel1 extends AppCompatActivity {
    ...
    public void dis_select(View view) {
        if (ed1.getText().toString().equals("Trivandrum")) {
        ...
        if (ed1.getText().toString().equals("Kollam")) {
        ...
        if (ed1.getText().toString().equals("Pathanamthitta")) {
        ...
        if (ed1.getText().toString().equals("Alappuzha")) {
        ...
        if (ed1.getText().toString().equals("Kottayam")) {
        ...
        if (ed1.getText().toString().equals("Idukki")) {
        ...
        if (ed1.getText().toString().equals("Ernakulam")) {
